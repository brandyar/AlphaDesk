...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-[#000000] h-screen flex flex-col flex-shrink-0 border-l border-[#282828] select-none">
      {/* Brand Header */}
      <div className="p-6 pb-4">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-[#1DB954] flex items-center justify-center text-black font-black text-lg shadow-lg shadow-[#1DB954]/20">
          ...
          <div>
            ...
            <p className="text-[#A7A7A7] text-xs">مدیریت ارتباط و پرسنل</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 mx-3 mb-3 rounded-lg bg-[#181818] border border-[#282828] text-[11px] text-[#A7A7A7] leading-relaxed">
        ...
        <p>
          مشتریان دارای مهلت زمانی هستند. در صورت عدم تبدیل در مهلت مقرر، سلب امتیاز و به لیست اشتراکی بازمی‌گردند.
        </p>
      </div>
      ...
      <div className="p-4 border-t border-[#282828] bg-[#0c0c0c] flex items-center justify-between">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-8 h-8 rounded-full bg-[#282828] flex items-center justify-center text-[#1DB954] font-bold text-xs border border-[#3e3e3e]">
